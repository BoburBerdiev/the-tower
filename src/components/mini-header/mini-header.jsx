...
const MiniHeader = ({img, title ,imageStyle}) => {
  return (
    <div className='w-full relative h-[30vh] flex flex-col items-center justify-center overflow-hidden'>
      <ImgUI src={img} alt={'banner'} imageStyle={imageStyle} objectFitContain={false} quality={80} />
      <div className='w-full h-full z-10 absolute top-0 left-0 bg-black/10'></div>
