...
const RoomsCharacterList = ({room_size , capacity , num_balconies , num_bathrooms}) => {
    ...
    return (
        <div
            ...
            <p className="px-2 flex gap-x-2 items-center"> <span> <MdBalcony className={'text-lg'} /></span> <span className={'text-nowrap'}>{num_bathrooms} {t('roomInner.balconySymbol')}</span> </p>
        </div>
    );
}
