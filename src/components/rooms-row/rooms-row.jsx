...
const RoomsRow = ({card  , order}) =>  {
    ...
    return (
        <div class={`grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-16 items-center max-md:mb-5 ${order % 2 === 0}  `}>
            <div data-aos='fade-out' class={`aspect-video md:aspect-[10/8] ${order % 2 === 0 ? 'order-2 md:order-1' : 'order-1 md:order-2'}`}>
