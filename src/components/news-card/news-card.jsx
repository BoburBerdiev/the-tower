  ...
  return (
    <a data-aos='fade-up' href={href} className={`block group w-full aspect-[14/16] lg:aspect-[16/18] relative overflow-hidden card-shadow duration-500 `}>
      ...
      <div className='w-full h-full duration-300 z-10 flex flex-col justify-end gap-4  '>
        <div className="relative z-10 duration-300 h-fit flex flex-col group-hover:pl-6 px-5 pb-4 md:pb-6 text-white space-y-2 before:h-full before:w-0 before:bg-brown before:absolute before:top-0 before:left-0 group-hover:before:w-2 before:duration-300 before:rounded-tr before:z-[99]">
